  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="space-y-6">
      ...
      <div className="glass-card p-6 flex flex-col items-center relative overflow-hidden">
        <div className="w-20 h-20 bg-[#111827] rounded-full border-2 border-accent mb-4 flex items-center justify-center text-2xl font-black">
           {name.charAt(0)}
        </div>
      ...
      <div className="glass-card p-6 space-y-4">
        ...
        <div className="flex gap-4">
          ...
          <div className="flex-1">
            <label className="text-[10px] uppercase font-bold text-text-muted px-2 block mb-1">Country</label>
            <input value={country} onChange={e=>setCountry(e.target.value)} className="w-full bg-[#111827] border border-border rounded-xl py-3 px-4 text-sm font-medium focus:border-accent outline-none" />
          </div>
        </div>
        {profile.role === 'Player' && (
          <div>
